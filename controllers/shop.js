...
exports.getAllProducts = (req, res, next) => {
    ...
    res.render('index', { name: 'Gurpreet', prods: products, path: '/', pageTitle: 'Home' });
};
...
exports.getCart = (req, res, next) => {
    res.render('cart', { cart: Cart.getCart(), pageTitle: 'Shopping Cart Detail', path: '/cart', name: 'Paramjeet' })
}
